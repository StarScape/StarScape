...
I subscribe to the "bicycle for the mind" philosophy of computing. I want to make software that enhances users' productivity and joy. I strive for [calm technology](https://calmtech.com/). I try to contribute back to open source projects that have done that for me.

I'm the developer of [Droplet](https://www.dropletwriter.com/), a rich text editor that attempts to fix the things I don't like about rich text editors. It's currently in alpha and has a long way to go.
...
I love connecting with interesting folks from the open source world, so if you want to chat, I'm reachable at the email in my profile.
